...
rm run.sh
#VSUMM1
python ../tools/osm_utility/osm_utiity_out.py ../videos/VSUMM ../user_summaries/VSUMM ../auto_summaries/VSUMM1 -cus -g -lfovs -lfovs_s 0.6 -lfovs_n 0.98 -lfovs_d 0.25 -lfovs_t 30 -lfovs_e 9
